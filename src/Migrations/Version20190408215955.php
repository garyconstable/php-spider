 ...
 */
final class Version20190408215955 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX url ON pending');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX email ON email (email)');
        $this->addSql('CREATE UNIQUE INDEX url ON external_domain (url)');
        $this->addSql('CREATE UNIQUE INDEX url ON pending (url)');
    }
}
